        ...
        @foreach ($data as $row)
            <tr>
                ...
                @if ($row->status_magang == 'Belum Disetujui')
                    <td><span class="badge badge-danger btn-sm">{{ $row->status_magang }}</span></td>
                @elseif($row->status_magang == 'Menunggu Validasi')
                    <td><span class="badge badge-warning btn-sm">{{ $row->status_magang }}</span></td>
                @else
                    <td><span class="badge badge-success btn-sm">{{ $row->status_magang }}</span></td>
                @endif
                ...
                @if (auth()->user()->level == 'Tenaga Pendidik' || auth()->user()->level == 'Tenaga Kependidikan')
                    <td>
                        <div class="d-flex justify-content-between">
                            @if ($row->status_magang == 'Sudah Disetujui')
